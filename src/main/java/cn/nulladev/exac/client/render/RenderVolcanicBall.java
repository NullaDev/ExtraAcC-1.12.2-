...
@RegEntityRender(EntityVolcanicBall.class)
public class RenderVolcanicBall extends Render<EntityVolcanicBall> {
	
	public RenderVolcanicBall(RenderManager renderManager) {
		super(renderManager);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void doRender(EntityVolcanicBall entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
		if (entity == null)
			return;
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityVolcanicBall p_110775_1_) {
		return null;
	}
}
